...
###########################################################################
# Пример Map Viewer показывает, как отображать карту и взаимодействовать
# с ней, искать адрес и находить маршруты проезда.
# Это большой пример, охватывающий множество основных применений карт,
# позиционирования и навигационных служб в Qt Location.
###########################################################################
